...
module Sharkk::Libudev
  ...
  module UdevWrappers
    # @return [Udev] 
    def ref()
      Udev.new Sharkk::Libudev.udev_ref(self)
    end
    
    # @return [Udev] 
    def unref()
      Udev.new Sharkk::Libudev.udev_unref(self)
    end
    
    # @param [FFI::Pointer(*)] log_fn 
    # @return [nil] 
    def set_log_fn(log_fn)
      Sharkk::Libudev.udev_set_log_fn(self, log_fn)
    end
    
    # @return [Integer] 
    def get_log_priority()
      Sharkk::Libudev.udev_get_log_priority(self)
    end
    
    # @param [Integer] priority 
    # @return [nil] 
    def set_log_priority(priority)
      Sharkk::Libudev.udev_set_log_priority(self, priority)
    end
    
    # @return [FFI::Pointer(*Void)] 
    def get_userdata()
      Sharkk::Libudev.udev_get_userdata(self)
    end
    
    # @param [FFI::Pointer(*Void)] userdata 
    # @return [nil] 
    def set_userdata(userdata)
      Sharkk::Libudev.udev_set_userdata(self, userdata)
    end
    
    # @param [String] syspath 
    # @return [UdevDevice] 
    def device_new_from_syspath(syspath)
      UdevDevice.new Sharkk::Libudev.udev_device_new_from_syspath(self, syspath)
    end
    ...
    def device_new_from_devnum(type, devnum)
      UdevDevice.new Sharkk::Libudev.udev_device_new_from_devnum(self, type, devnum)
    end
    ...
    def device_new_from_subsystem_sysname(subsystem, sysname)
      UdevDevice.new Sharkk::Libudev.udev_device_new_from_subsystem_sysname(self, subsystem, sysname)
    end
    
    # @param [String] id 
    # @return [UdevDevice] 
    def device_new_from_device_id(id)
      UdevDevice.new Sharkk::Libudev.udev_device_new_from_device_id(self, id)
    end
    
    # @return [UdevDevice] 
    def device_new_from_environment()
      UdevDevice.new Sharkk::Libudev.udev_device_new_from_environment(self)
    end
    
    # @param [String] name 
    # @return [UdevMonitor] 
    def monitor_new_from_netlink(name)
      UdevMonitor.new Sharkk::Libudev.udev_monitor_new_from_netlink(self, name)
    end
    
    # @return [UdevEnumerate] 
    def enumerate_new()
      UdevEnumerate.new Sharkk::Libudev.udev_enumerate_new(self)
    end
    
    # @return [UdevQueue] 
    def queue_new()
      UdevQueue.new Sharkk::Libudev.udev_queue_new(self)
    end
    
    # @return [UdevHwdb] 
    def hwdb_new()
      UdevHwdb.new Sharkk::Libudev.udev_hwdb_new(self)
    end
  end
  ...
  module UdevListEntryWrappers
    ...
    def get_next()
      UdevListEntry.new Sharkk::Libudev.udev_list_entry_get_next(self)
    end
    
    # @param [String] name 
    # @return [UdevListEntry] 
    def get_by_name(name)
      UdevListEntry.new Sharkk::Libudev.udev_list_entry_get_by_name(self, name)
    end
    
    # @return [String] 
    def get_name()
      Sharkk::Libudev.udev_list_entry_get_name(self)
    end
    
    # @return [String] 
    def get_value()
      Sharkk::Libudev.udev_list_entry_get_value(self)
    end
  end
  ...
  module UdevDeviceWrappers
    # @return [UdevDevice] 
    def ref()
      UdevDevice.new Sharkk::Libudev.udev_device_ref(self)
    end
    
    # @return [UdevDevice] 
    def unref()
      UdevDevice.new Sharkk::Libudev.udev_device_unref(self)
    end
    
    # @return [Udev] 
    def get_udev()
      Udev.new Sharkk::Libudev.udev_device_get_udev(self)
    end
    
    # @return [UdevDevice] 
    def get_parent()
      UdevDevice.new Sharkk::Libudev.udev_device_get_parent(self)
    end
    ...
    def get_parent_with_subsystem_devtype(subsystem, devtype)
      UdevDevice.new Sharkk::Libudev.udev_device_get_parent_with_subsystem_devtype(self, subsystem, devtype)
    end
    
    # @return [String] 
    def get_devpath()
      Sharkk::Libudev.udev_device_get_devpath(self)
    end
    
    # @return [String] 
    def get_subsystem()
      Sharkk::Libudev.udev_device_get_subsystem(self)
    end
    
    # @return [String] 
    def get_devtype()
      Sharkk::Libudev.udev_device_get_devtype(self)
    end
    
    # @return [String] 
    def get_syspath()
      Sharkk::Libudev.udev_device_get_syspath(self)
    end
    
    # @return [String] 
    def get_sysname()
      Sharkk::Libudev.udev_device_get_sysname(self)
    end
    
    # @return [String] 
    def get_sysnum()
      Sharkk::Libudev.udev_device_get_sysnum(self)
    end
    
    # @return [String] 
    def get_devnode()
      Sharkk::Libudev.udev_device_get_devnode(self)
    end
    
    # @return [Integer] 
    def get_is_initialized()
      Sharkk::Libudev.udev_device_get_is_initialized(self)
    end
    
    # @return [UdevListEntry] 
    def get_devlinks_list_entry()
      UdevListEntry.new Sharkk::Libudev.udev_device_get_devlinks_list_entry(self)
    end
    
    # @return [UdevListEntry] 
    def get_properties_list_entry()
      UdevListEntry.new Sharkk::Libudev.udev_device_get_properties_list_entry(self)
    end
    
    # @return [UdevListEntry] 
    def get_tags_list_entry()
      UdevListEntry.new Sharkk::Libudev.udev_device_get_tags_list_entry(self)
    end
    
    # @return [UdevListEntry] 
    def get_sysattr_list_entry()
      UdevListEntry.new Sharkk::Libudev.udev_device_get_sysattr_list_entry(self)
    end
    
    # @param [String] key 
    # @return [String] 
    def get_property_value(key)
      Sharkk::Libudev.udev_device_get_property_value(self, key)
    end
    
    # @return [String] 
    def get_driver()
      Sharkk::Libudev.udev_device_get_driver(self)
    end
    
    # @return [Integer] 
    def get_devnum()
      Sharkk::Libudev.udev_device_get_devnum(self)
    end
    
    # @return [String] 
    def get_action()
      Sharkk::Libudev.udev_device_get_action(self)
    end
    
    # @return [Integer] 
    def get_seqnum()
      Sharkk::Libudev.udev_device_get_seqnum(self)
    end
    
    # @return [Integer] 
    def get_usec_since_initialized()
      Sharkk::Libudev.udev_device_get_usec_since_initialized(self)
    end
    
    # @param [String] sysattr 
    # @return [String] 
    def get_sysattr_value(sysattr)
      Sharkk::Libudev.udev_device_get_sysattr_value(self, sysattr)
    end
    ...
    def set_sysattr_value(sysattr, value)
      Sharkk::Libudev.udev_device_set_sysattr_value(self, sysattr, value)
    end
    
    # @param [String] tag 
    # @return [Integer] 
    def has_tag(tag)
      Sharkk::Libudev.udev_device_has_tag(self, tag)
    end
  end
  ...
  module UdevMonitorWrappers
    # @return [UdevMonitor] 
    def ref()
      UdevMonitor.new Sharkk::Libudev.udev_monitor_ref(self)
    end
    
    # @return [UdevMonitor] 
    def unref()
      UdevMonitor.new Sharkk::Libudev.udev_monitor_unref(self)
    end
    
    # @return [Udev] 
    def get_udev()
      Udev.new Sharkk::Libudev.udev_monitor_get_udev(self)
    end
    
    # @return [Integer] 
    def enable_receiving()
      Sharkk::Libudev.udev_monitor_enable_receiving(self)
    end
    
    # @param [Integer] size 
    # @return [Integer] 
    def set_receive_buffer_size(size)
      Sharkk::Libudev.udev_monitor_set_receive_buffer_size(self, size)
    end
    
    # @return [Integer] 
    def get_fd()
      Sharkk::Libudev.udev_monitor_get_fd(self)
    end
    
    # @return [UdevDevice] 
    def receive_device()
      UdevDevice.new Sharkk::Libudev.udev_monitor_receive_device(self)
    end
    ...
    def filter_add_match_subsystem_devtype(subsystem, devtype)
      Sharkk::Libudev.udev_monitor_filter_add_match_subsystem_devtype(self, subsystem, devtype)
    end
    
    # @param [String] tag 
    # @return [Integer] 
    def filter_add_match_tag(tag)
      Sharkk::Libudev.udev_monitor_filter_add_match_tag(self, tag)
    end
    
    # @return [Integer] 
    def filter_update()
      Sharkk::Libudev.udev_monitor_filter_update(self)
    end
    
    # @return [Integer] 
    def filter_remove()
      Sharkk::Libudev.udev_monitor_filter_remove(self)
    end
  end
  ...
  module UdevEnumerateWrappers
    # @return [UdevEnumerate] 
    def ref()
      UdevEnumerate.new Sharkk::Libudev.udev_enumerate_ref(self)
    end
    
    # @return [UdevEnumerate] 
    def unref()
      UdevEnumerate.new Sharkk::Libudev.udev_enumerate_unref(self)
    end
    
    # @return [Udev] 
    def get_udev()
      Udev.new Sharkk::Libudev.udev_enumerate_get_udev(self)
    end
    
    # @param [String] subsystem 
    # @return [Integer] 
    def add_match_subsystem(subsystem)
      Sharkk::Libudev.udev_enumerate_add_match_subsystem(self, subsystem)
    end
    
    # @param [String] subsystem 
    # @return [Integer] 
    def add_nomatch_subsystem(subsystem)
      Sharkk::Libudev.udev_enumerate_add_nomatch_subsystem(self, subsystem)
    end
    ...
    def add_match_sysattr(sysattr, value)
      Sharkk::Libudev.udev_enumerate_add_match_sysattr(self, sysattr, value)
    end
    ...
    def add_nomatch_sysattr(sysattr, value)
      Sharkk::Libudev.udev_enumerate_add_nomatch_sysattr(self, sysattr, value)
    end
    ...
    def add_match_property(property, value)
      Sharkk::Libudev.udev_enumerate_add_match_property(self, property, value)
    end
    
    # @param [String] sysname 
    # @return [Integer] 
    def add_match_sysname(sysname)
      Sharkk::Libudev.udev_enumerate_add_match_sysname(self, sysname)
    end
    
    # @param [String] tag 
    # @return [Integer] 
    def add_match_tag(tag)
      Sharkk::Libudev.udev_enumerate_add_match_tag(self, tag)
    end
    
    # @param [UdevDevice] parent 
    # @return [Integer] 
    def add_match_parent(parent)
      Sharkk::Libudev.udev_enumerate_add_match_parent(self, parent)
    end
    
    # @return [Integer] 
    def add_match_is_initialized()
      Sharkk::Libudev.udev_enumerate_add_match_is_initialized(self)
    end
    
    # @param [String] syspath 
    # @return [Integer] 
    def add_syspath(syspath)
      Sharkk::Libudev.udev_enumerate_add_syspath(self, syspath)
    end
    
    # @return [Integer] 
    def scan_devices()
      Sharkk::Libudev.udev_enumerate_scan_devices(self)
    end
    
    # @return [Integer] 
    def scan_subsystems()
      Sharkk::Libudev.udev_enumerate_scan_subsystems(self)
    end
    
    # @return [UdevListEntry] 
    def get_list_entry()
      UdevListEntry.new Sharkk::Libudev.udev_enumerate_get_list_entry(self)
    end
  end
  ...
  module UdevQueueWrappers
    # @return [UdevQueue] 
    def ref()
      UdevQueue.new Sharkk::Libudev.udev_queue_ref(self)
    end
    
    # @return [UdevQueue] 
    def unref()
      UdevQueue.new Sharkk::Libudev.udev_queue_unref(self)
    end
    
    # @return [Udev] 
    def get_udev()
      Udev.new Sharkk::Libudev.udev_queue_get_udev(self)
    end
    
    # @return [Integer] 
    def get_kernel_seqnum()
      Sharkk::Libudev.udev_queue_get_kernel_seqnum(self)
    end
    
    # @return [Integer] 
    def get_udev_seqnum()
      Sharkk::Libudev.udev_queue_get_udev_seqnum(self)
    end
    
    # @return [Integer] 
    def get_udev_is_active()
      Sharkk::Libudev.udev_queue_get_udev_is_active(self)
    end
    
    # @return [Integer] 
    def get_queue_is_empty()
      Sharkk::Libudev.udev_queue_get_queue_is_empty(self)
    end
    
    # @param [Integer] seqnum 
    # @return [Integer] 
    def get_seqnum_is_finished(seqnum)
      Sharkk::Libudev.udev_queue_get_seqnum_is_finished(self, seqnum)
    end
    ...
    def get_seqnum_sequence_is_finished(start, end_)
      Sharkk::Libudev.udev_queue_get_seqnum_sequence_is_finished(self, start, end_)
    end
    
    # @return [Integer] 
    def get_fd()
      Sharkk::Libudev.udev_queue_get_fd(self)
    end
    
    # @return [Integer] 
    def flush()
      Sharkk::Libudev.udev_queue_flush(self)
    end
    
    # @return [UdevListEntry] 
    def get_queued_list_entry()
      UdevListEntry.new Sharkk::Libudev.udev_queue_get_queued_list_entry(self)
    end
  end
  ...
  module UdevHwdbWrappers
    # @return [UdevHwdb] 
    def ref()
      UdevHwdb.new Sharkk::Libudev.udev_hwdb_ref(self)
    end
    
    # @return [UdevHwdb] 
    def unref()
      UdevHwdb.new Sharkk::Libudev.udev_hwdb_unref(self)
    end
    ...
    def get_properties_list_entry(modalias, flags)
      UdevListEntry.new Sharkk::Libudev.udev_hwdb_get_properties_list_entry(self, modalias, flags)
    end
  end
